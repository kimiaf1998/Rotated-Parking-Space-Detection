...
def worker(rank, args, world, model, state):
    ...
    if args.command == 'train':
        ...
        # train.train(model, state, 'C:\\Users\\kimia\\PycharmProjects\\ParkingSpaceDetection\\dataset\\data\\images',
        #             'C:\\Users\\kimia\\PycharmProjects\\ParkingSpaceDetection\\dataset\\data\\train.json',
        #             'C:\\Users\\kimia\\PycharmProjects\\ParkingSpaceDetection\\dataset\\data\\images',
        #             'C:\\Users\\kimia\\PycharmProjects\\ParkingSpaceDetection\\dataset\\data\\valid.json', args.resize, args.max_size, args.jitter,
        #             args.batch, int(args.iters * args.schedule), args.val_iters, args.lr, args.warmup,
        #             [int(m * args.schedule) for m in args.milestones], args.gamma, rank, world=world,
        #             mixed_precision=not args.full_precision, with_apex=args.with_apex, use_dali=args.with_dali,
        #             metrics_url=args.post_metrics, logdir=args.logdir, verbose=(rank == 0),
        #             rotate_augment=args.augment_rotate, augment_brightness=args.augment_brightness,
        #             augment_contrast=args.augment_contrast, augment_hue=args.augment_hue,
